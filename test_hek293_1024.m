...
Ho = double(imread('C:\Users\EEE\Pictures\Experiment\200524\Image-34.tif'));
Ho = Ho(1025:2048,1025:2048);
Hr = double(imread('C:\Users\EEE\Pictures\Experiment\200524\Image-36.tif'));
Hr = Hr(1025:2048,1025:2048);
Ho = Ho - mean(Hr(:));
% Ho = double(imread('D:\PhD\PhD_ProjectWork\MatLab Code\Skin Cancer\Mxiture_cell_dataset\A375_more\A375_more\Image-4.tif'));
Ho_upd = padarray(Ho,[150 150],0,'both');
[M,N] = size(Ho_upd);
zeta = 1:M; 
eta = 1:N;
...
%%
angles = 0.89:0.001:0.91;
% angles = 0.88:0.01:0.98;
% angles = 0:0.1:1;
...
%%
spectrum_o = frft22d(Ho_upd,[0.897, 0.897]);%FT2Dc(y_img); % HDF
...
% figure; imagesc(rec_phase_unwrapped_1); colormap gray; axis on;
...
% imwrite(TP,gray,'C:\Users\EEE\Desktop\object_detection_hek-293\Hek_293\hek_34_1024.tif');
